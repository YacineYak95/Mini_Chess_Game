...
// ********************************************************
	...
	for (i=0; i<8; i++)
	   for (j=0; j<8; j++) {
		switch (conf.mat[i][j]) {
            ...
            case -'p' : pionN = pionN + pawnTable[i][j];
                        break;
                
            case -'c' : cN = cN + knightTable[i][j];
                        break;
                
            case -'f' : fN = fN + bishopTable[i][j];
                        break;
                
            case -'t' : tN = tN + rookTable[i][j];
                        break;
                
            case -'n' : nN = queenTable[i][j];
                        break;

            case -'r' :  rN = kingTable[i][j];
                         break;
        }
       }
	...
	ScrQte = ( (pionB + fB + tB + nB + cB + rB) - ( pionN + fN + tN + nN + cN + rN) ) * 1.4;
