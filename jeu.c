...
/***                                                               ***/
/*** Il est demandé d'améliorer la fonction (...) ci-dessous. ***/
...
// ********************************************************
	...
	int i, j, ScrQte;
	int pionB = 0, pionN = 0, fB = 0, fN = 0, tB = 0, tN = 0, nB = 0, nN = 0,cB = 0, cN = 0, rN = 0, rB = 0;
    int menacePB = 0, menacePN = 0, menaceCB = 0, menaceCN = 0, menaceTB = 0, menaceTN = 0, menaceNB = 0, menaceNN = 0 , menaceFB=0 , menaceFN=0;
    int menace=0,MenaceScr=0;
	...
	for (i=0; i<8; i++)
	   for (j=0; j<8; j++) {
		switch (conf.mat[i][j]) {
            ...
            case 'p' :  pionB = pionB + pawnTable[i][j];
                        pionB++;
                        menace = caseMenaceePar(MIN,i,j,conf);
                        switch (menace){
                            case 'p' : menacePB = menacePB + 30;   break;
                            case 'c' : menacePB++;  break;
                            case 'f' : menacePB++;  break;
                            case 't' : menacePB++; break;
                            case 'n' : menacePB++;  break;
                        }
            break;
                
            case 'c' :  cB = cB + knightTable[i][j];
                        cB++;
                        menace = caseMenaceePar(MIN,i,j,conf);
                        switch (menace){
                            case 'p' : menaceCB +=  60;   break;
                            case 'c' : menaceCB +=30;  break;
                            case 'f' : menaceCB += 30;  break;
                            case 't' : menaceCB++; break;
                            case 'n' : menaceCB++;  break;
                        }
                        break;
                
            case 'f' :  fB = fB + bishopTable[i][j];
                        fB++;
                        menace = caseMenaceePar(MIN,i,j,conf);
                        switch (menace){
                            case 'p' : menaceFB +=  60;   break;
                            case 'c' : menaceFB++;  break;
                            case 'f' : menaceFB += 30;  break;
                            case 't' : menaceFB++; break;
                            case 'n' : menaceFB++;  break;
                        }
                        break;
                
            case 't' :  tB = tB + rookTable[i][j];
                        tB++;
                        menace = caseMenaceePar(MIN,i,j,conf);
                        switch (menace){
                            case 'p' : menaceTB +=  90;   break;
                            case 'c' : menaceTB++;  break;
                            case 'f' : menaceTB += 60;  break;
                            case 't' : menaceTB += 30; break;
                            case 'n' : menaceTB += 10;  break;
                        }
                        break;
                
            case 'n' :  nB = queenTable[i][j];
                        nB++;
                        menace = caseMenaceePar(MIN,i,j,conf);
                        switch (menace){
                            case 'p' : menaceNB +=  120;   break;
                            case 'c' : menaceNB++;  break;
                            case 'f' : menaceNB += 90;  break;
                            case 't' : menaceNB += 60; break;
                            case 'n' : menaceNB += 30;  break;
                        }
                break;
                        break;
                
            case 'r' :  rB = kingTable[i][j];
                        break;
                
            case -'p' : pionN = pionN + pawnTable[7-i][7-j];
                        pionN++;
                        menace = caseMenaceePar(MAX,i,j,conf);
                        switch (menace){
                            case 'p' : menacePN = menacePB + 30;   break;
                            case 'c' : menacePN++;  break;
                            case 'f' : menacePN++;  break;
                            case 't' : menacePN++; break;
                            case 'n' : menacePN++;  break;
                        }
                        break;
                
            case -'c' : cN = cN + knightTable[7-i][7-j];
                        cN++;
                        menace = caseMenaceePar(MAX,i,j,conf);
                        switch (menace){
                            case 'p' : menaceCN +=  60;   break;
                            case 'c' : menaceCN +=30;  break;
                            case 'f' : menaceCN += 30;  break;
                            case 't' : menaceCN++; break;
                            case 'n' : menaceCN++;  break;
                        }
                        break;
                
            case -'f' : fN = fN + bishopTable[7-i][7-j];
                        fN++;
                        menace = caseMenaceePar(MAX,i,j,conf);
                        switch (menace){
                            case 'p' : menaceFN +=  60;   break;
                            case 'c' : menaceFN++;  break;
                            case 'f' : menaceFN += 30;  break;
                            case 't' : menaceFN++; break;
                            case 'n' : menaceFN++;  break;
                        }
                        break;
                
            case -'t' : tN = tN + rookTable[7-i][7-j];
                        tN++;
                        menace = caseMenaceePar(MAX,i,j,conf);
                        switch (menace){
                            case 'p' : menaceTN +=  90;   break;
                            case 'c' : menaceTN++;  break;
                            case 'f' : menaceTN += 60;  break;
                            case 't' : menaceTN += 30; break;
                            case 'n' : menaceTN += 10;  break;
                        }
                        break;
                
            case -'n' : nN = queenTable[7-i][7-j];
                        nN++;
                        menace = caseMenaceePar(MAX,i,j,conf);
                        switch (menace){
                            case 'p' : menaceNN +=  120;   break;
                            case 'c' : menaceNN++;  break;
                            case 'f' : menaceNN += 90;  break;
                            case 't' : menaceNN += 60; break;
                            case 'n' : menaceNN += 30;  break;
                        }
                        break;

            case -'r' :  rN = kingTable[7-i][7-j];
                         break;
        }
       }

    MenaceScr = ((menacePN+ menaceCN*3 + menaceFN*3 + menaceTN*5+ menaceNN*10)-(menacePB + menaceCB*3 + menaceFB*3 + menaceTB*5 + menaceNB*10))*1.4;
    
	// Somme pondérée de pièces de chaque joueur. 
	// Le facteur 1.4 pour ne pas sortir de l'intervalle ]-100 , +100[
	ScrQte = ( (pionB + fB*3 + tB*6 + nB*12 + cB*3 + rB) - ( pionN + fN*3 + tN*6 + nN*12 + cN*3 + rN) ) * 1.4;
    ...
    for(i=8; i>0; i--)  {
        ...
        for (j=0; j<8; j++)
            if ( conf.mat[i-1][j] < 0 ) {
                ...
                if(-conf.mat[i-1][j]=='r') printf("\t \xe2\x99\x9a");
                if(-conf.mat[i-1][j]=='n') printf("\t \xe2\x99\x9b");
                if(-conf.mat[i-1][j]=='p') printf("\t \xe2\x99\x9f");
                if(-conf.mat[i-1][j]=='f') printf("\t \xe2\x99\x9d");
                if(-conf.mat[i-1][j]=='c') printf("\t \xe2\x99\x9e");
                if(-conf.mat[i-1][j]=='t') printf("\t \xe2\x99\x9c");
                ...
                if ( conf.mat[i-1][j] > 0 ){
                    ...
                    if(conf.mat[i-1][j]=='r') printf("\t \xe2\x99\x94");
                    if(conf.mat[i-1][j]=='n') printf("\t \xe2\x99\x95");
                    if(conf.mat[i-1][j]=='p') printf("\t \xe2\x99\x99");
                    if(conf.mat[i-1][j]=='f') printf("\t \xe2\x99\x97");
                    if(conf.mat[i-1][j]=='c') printf("\t \xe2\x99\x98");
                    if(conf.mat[i-1][j]=='t') printf("\t \xe2\x99\x96");
                }
                else{ printf("\t  ");
                }
            }
